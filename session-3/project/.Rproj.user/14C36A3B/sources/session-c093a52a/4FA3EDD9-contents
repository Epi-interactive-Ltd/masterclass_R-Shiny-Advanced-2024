...
shinyServer(function(input, output) {
  ...
  filtered_data <- eventReactive(input$go, {
    # Use req() to prevent the filtered data from calculating if input$country is not ready  
    ...
    # Use validate and need to show a warning if there is no rows in the filtered data
...
# Table stuff -------------------------------------------------------------
  ...
  output$table <- renderDataTable({ 
    ...
    # Modify the table to that the table sorts by GDP in ascending order by default
